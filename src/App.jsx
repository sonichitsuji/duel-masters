...
import { DECK_BOLSHACK, DECK_MIRADANTE, DECK_HEAVENS, DECK_DOOM, DECK_ACE, DECK_JAOUMON, DECK_TAKONCHU } from "./decks";
...
const SAMPLE_DECKS = [
  ...
  { name: "4c邪王門", ids: DECK_JAOUMON },
  { name: "カウンタータコ宇宙", ids: DECK_TAKONCHU },
];
